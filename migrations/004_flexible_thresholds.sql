-- ══════════════════════════════════════════════════════════════
--  004 — Thresholds de oportunidades configuráveis no dashboard
--
--  Move os filtros de negócio fixos (vendas do validador, prova
--  de mercado e rating do alvo) da view para sliders do dashboard,
--  permitindo trabalhar com nichos de menor volume (ex: queijo
--  artesanal) sem alterar o comportamento padrão.
--
--  Inclui também url_validador (adicionado na 003).
--
--  Rode no SQL Editor do Supabase antes de reiniciar o dashboard.
-- ══════════════════════════════════════════════════════════════
...
-- Apenas filtros estruturais — thresholds de negócio ficam no dashboard
